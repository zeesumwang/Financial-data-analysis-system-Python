...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.combobox.addItems(["回测分析系统","分析十大股东","获取历史K线", "获取复权数据", "获取分笔数据", "获取历史分钟数据"])

        self.horizontalLayout_3.addWidget(self.combobox)
        #左侧选着窗口大小
        spacerItem = QtWidgets.QSpacerItem(210, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
